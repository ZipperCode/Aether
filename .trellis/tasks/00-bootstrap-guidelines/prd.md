...
- [ ] Fill guidelines for aether-tunnel
- [ ] Fill guidelines for aether-ai-formats
- [ ] Fill guidelines for aether-admin
- [ ] Fill guidelines for aether-admission-core
- [ ] Fill guidelines for aether-ai-serving
- [ ] Fill guidelines for aether-pool-core
- [ ] Fill guidelines for aether-provider-core
- [ ] Fill guidelines for aether-provider-pool
- [ ] Fill guidelines for aether-routing-core
- [ ] Fill guidelines for aether-data-contracts
- [ ] Fill guidelines for aether-data-postgres
- [ ] Fill guidelines for aether-data-mysql
- [ ] Fill guidelines for aether-data-sqlite
- [ ] Fill guidelines for aether-data-query
- [ ] Fill guidelines for aether-data-schema
- [ ] Fill guidelines for aether-dispatch-core
...
- [ ] Fill guidelines for aether-task-core
- [ ] Fill guidelines for aether-gateway-frontdoor
- [ ] Fill guidelines for aether-gateway-control
- [ ] Fill guidelines for aether-gateway-execution
- [ ] Fill guidelines for aether-gateway-workers
- [ ] Fill guidelines for aether-gateway-tunnel
- [ ] Fill guidelines for aether-loadtools
- [ ] Fill guidelines for aether-integration-tests
- [ ] Fill guidelines for aether-usage-core
- [ ] Fill guidelines for aether-test-support
...
### Package: aether-tunnel (`spec/aether-tunnel/`)

- Backend guidelines: `.trellis/spec/aether-tunnel/backend/`
...
### Package: aether-admission-core (`spec/aether-admission-core/`)

- Backend guidelines: `.trellis/spec/aether-admission-core/backend/`

### Package: aether-ai-serving (`spec/aether-ai-serving/`)

- Backend guidelines: `.trellis/spec/aether-ai-serving/backend/`

### Package: aether-pool-core (`spec/aether-pool-core/`)

- Backend guidelines: `.trellis/spec/aether-pool-core/backend/`

### Package: aether-provider-core (`spec/aether-provider-core/`)

- Backend guidelines: `.trellis/spec/aether-provider-core/backend/`

### Package: aether-provider-pool (`spec/aether-provider-pool/`)

- Backend guidelines: `.trellis/spec/aether-provider-pool/backend/`

### Package: aether-routing-core (`spec/aether-routing-core/`)

- Backend guidelines: `.trellis/spec/aether-routing-core/backend/`

### Package: aether-data-contracts (`spec/aether-data-contracts/`)

- Backend guidelines: `.trellis/spec/aether-data-contracts/backend/`

### Package: aether-data-postgres (`spec/aether-data-postgres/`)

- Backend guidelines: `.trellis/spec/aether-data-postgres/backend/`

### Package: aether-data-mysql (`spec/aether-data-mysql/`)

- Backend guidelines: `.trellis/spec/aether-data-mysql/backend/`

### Package: aether-data-sqlite (`spec/aether-data-sqlite/`)

- Backend guidelines: `.trellis/spec/aether-data-sqlite/backend/`

### Package: aether-data-query (`spec/aether-data-query/`)

- Backend guidelines: `.trellis/spec/aether-data-query/backend/`

### Package: aether-data-schema (`spec/aether-data-schema/`)

- Backend guidelines: `.trellis/spec/aether-data-schema/backend/`

### Package: aether-dispatch-core (`spec/aether-dispatch-core/`)

- Backend guidelines: `.trellis/spec/aether-dispatch-core/backend/`
...
### Package: aether-task-core (`spec/aether-task-core/`)

- Backend guidelines: `.trellis/spec/aether-task-core/backend/`

### Package: aether-gateway-frontdoor (`spec/aether-gateway-frontdoor/`)

- Backend guidelines: `.trellis/spec/aether-gateway-frontdoor/backend/`

### Package: aether-gateway-control (`spec/aether-gateway-control/`)

- Backend guidelines: `.trellis/spec/aether-gateway-control/backend/`

### Package: aether-gateway-execution (`spec/aether-gateway-execution/`)

- Backend guidelines: `.trellis/spec/aether-gateway-execution/backend/`

### Package: aether-gateway-workers (`spec/aether-gateway-workers/`)

- Backend guidelines: `.trellis/spec/aether-gateway-workers/backend/`

### Package: aether-gateway-tunnel (`spec/aether-gateway-tunnel/`)

- Backend guidelines: `.trellis/spec/aether-gateway-tunnel/backend/`

### Package: aether-loadtools (`spec/aether-loadtools/`)

- Backend guidelines: `.trellis/spec/aether-loadtools/backend/`

### Package: aether-integration-tests (`spec/aether-integration-tests/`)

- Backend guidelines: `.trellis/spec/aether-integration-tests/backend/`

### Package: aether-usage-core (`spec/aether-usage-core/`)

- Backend guidelines: `.trellis/spec/aether-usage-core/backend/`

### Package: aether-test-support (`spec/aether-test-support/`)

- Backend guidelines: `.trellis/spec/aether-test-support/backend/`
