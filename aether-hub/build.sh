...
#   ./build.sh --image --tag sha-abc123 --image-name ghcr.io/zippercode/aether-hub --push
...
# image mode options
IMAGE_NAME="${IMAGE_NAME:-ghcr.io/zippercode/aether-hub}"
IMAGE_TAG=""
...
image 模式:
  ...
  --image-name <name>      镜像名（默认 ghcr.io/zippercode/aether-hub）
