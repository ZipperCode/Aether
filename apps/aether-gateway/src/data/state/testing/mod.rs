...
use super::{
    ...
    MinimalCandidateSelectionReadRepository, ModelCatalogReadRepository,
    OAuthProviderReadRepository, OAuthProviderWriteRepository, PoolMemberScoreWriteRepository,
...
impl GatewayDataState {
    ...
    pub(crate) fn with_model_catalog_reader(
        mut self,
        repository: Arc<dyn ModelCatalogReadRepository>,
    ) -> Self {
        self.model_catalog_reader = Some(repository);
        self
    }
