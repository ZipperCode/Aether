...
use crate::contracts::{
    ...
    GEMINI_CLI_SYNC_PLAN_KIND, GEMINI_COUNT_TOKENS_SYNC_PLAN_KIND, GEMINI_EMBEDDING_SYNC_PLAN_KIND,
...
pub fn resolve_execution_runtime_sync_plan_kind_with_client_surface(
    ...
    {
        return Some(GEMINI_COUNT_TOKENS_SYNC_PLAN_KIND);
    }
...
pub fn supports_sync_execution_decision_kind(plan_kind: &str) -> bool {
    matches!(
        ...
        OPENAI_CHAT_SYNC_PLAN_KIND
            ...
            | GEMINI_COUNT_TOKENS_SYNC_PLAN_KIND
            | GEMINI_CHAT_SYNC_PLAN_KIND
            | GEMINI_CLI_SYNC_PLAN_KIND
