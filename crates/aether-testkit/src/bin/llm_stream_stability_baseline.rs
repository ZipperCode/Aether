...
fn print_usage() {
    eprintln!(
        "usage: cargo run -p aether-testkit --bin llm_stream_stability_baseline -- [--streams 120] [--concurrency 30] [--chunks 240 | --stream-seconds 60] [--chunk-bytes 1024] [--chunk-delay-ms 250] [--jitter-ms 0] [--first-byte-delay-ms 100] [--idle-timeout-ms 10000] [--request-timeout-ms auto] [--request-gate-limit concurrency+1] [--tunnel-max-streams 256] [--outbound-queue-capacity 512] [--ping-interval-ms 5000] [--output /tmp/llm_stream_stability.json]"
    );
}
