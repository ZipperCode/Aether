...
export type ProviderType = 'custom' | 'claude_code' | 'codex' | 'chatgpt_web' | 'gemini_cli' | 'antigravity' | 'kiro' | 'grok' | 'xai' | 'nous' | 'windsurf' | 'vertex_ai' | 'deepseek' | 'openrouter' | 'moonshot' | 'kimi_coding' | 'siliconflow' | 'zhipu' | 'zai' | 'minimax'
