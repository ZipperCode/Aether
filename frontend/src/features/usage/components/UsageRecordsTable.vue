        ...
        >
          ...
          >
            ...
            <Ban
              v-if="!isAdmin && record.has_skipped_candidate"
              data-usage-attempt-marker="skipped-candidate"
              class="inline-block ml-1 w-3.5 h-3.5 text-slate-500 dark:text-slate-400 align-middle"
              title="本次有候选在调度阶段被跳过，请求未发往该候选"
              aria-label="有候选被调度跳过"
            />
          </TableCell>
