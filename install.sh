...
SOURCE_REF="${AETHER_SOURCE_REF:-master}"
...
IMAGE_REPO="${AETHER_IMAGE_REPO:-ghcr.io/zippercode/aether}"
...
Options:
  ...
  --channel CHANNEL    Release channel to resolve when --version is omitted: stable, latest, rc, beta, or nightly
                      ...
                      nightly resolves the rolling nightly build from master
  ...
  --source-ref REF     Source branch/tag used for compose templates (default: master)
